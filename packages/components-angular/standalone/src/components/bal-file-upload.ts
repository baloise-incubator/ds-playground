...
import type { Components, FileUploadRejectedFile } from '@baloise/ds-components'
import { defineCustomElement } from '@baloise/ds-components/components/bal-file-upload'
